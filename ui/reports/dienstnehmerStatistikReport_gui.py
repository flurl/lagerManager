...
class Ui_DienstnehmerStatistik(object):
    def setupUi(self, DienstnehmerStatistik):
        ...
        self.checkBox_showSalary = QtGui.QCheckBox(DienstnehmerStatistik)
        self.checkBox_showSalary.setObjectName(_fromUtf8("checkBox_showSalary"))
        self.horizontalLayout.addWidget(self.checkBox_showSalary)
    ...
    def retranslateUi(self, DienstnehmerStatistik):
        ...
        self.checkBox_singlePeriods.setText(_translate("DienstnehmerStatistik", "&einzeln", None))
        self.checkBox_showSalary.setText(_translate("DienstnehmerStatistik", "&Lohn", None))
