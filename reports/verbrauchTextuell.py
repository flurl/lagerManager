...
class VerbrauchTextuellReport(TextReport):
	...
	def mkConsQuery(self):
		...
		query = """
				...
				artikel_zutaten, tische_aktiv, tische_bons, tische_bondetails, journal_checkpoints, lager_artikel, lager_einheiten, rechnungen_basis
				where 1=1
		...
		query += """
				...
				journal_checkpoints, tische_aktiv, tische_bons, rechnungen_basis
				where 1=1
